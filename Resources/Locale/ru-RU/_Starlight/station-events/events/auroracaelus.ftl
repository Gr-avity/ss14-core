station-event-auroracaelus-start-announcement =
    A harmless cloud of ions is approaching your station, and will exhaust their energy battering the hull.
...
station-event-auroracaelus-end-announcement =
    The Aurora Caelus event is now ending. Starlight conditions have returned to normal, and the cloud has dissipated.
