...
xenobiology-console-monkey-cube-inserted =
    Thanks for inserting a monkey cube! The console now has { $cubes } { $cubes ->
        [1] cube
       *[other] cubes
    }.
xenobiology-console-mutation-potion-inserted =
    Thanks for inserting a mutation potion! The console now has { $potions } { $potions ->
        [1] potion
       *[other] potions
    }.
xenobiology-console-stabilizer-potion-inserted =
    Thanks for inserting a stabilizer potion! The console now has { $potions } { $potions ->
        [1] potion
       *[other] potions
    }.
...
xenobiology-console-monkey-placed =
    Placed down a monkey. You now have { $cubes } { $cubes ->
        [1] cube
       *[other] cubes
    }.
...
xenobiology-console-monkey-recycled =
    { GENDER($user) ->
        [1] monkey
       *[other] monkeys
