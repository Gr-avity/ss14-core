...
secure-terminal-alert-time-remaining =
    { $minutes ->
...
secure-terminal-on-cooldown-note =
    { $minutes ->
...
secure-terminal-activation-countdown =
    { $request } has been fully authorized.
...
secure-terminal-admin =
    Requesting Admin Approval for: { $request }
    Reason: { $reason }
...
secure-terminal-warops-security-desc =
    Deploys an ERT Security detail specialized for War Ops. Only available during War Ops.
...
secure-terminal-ert-engineering-desc =
    Deploys an ERT Engineering detail to assist with critical station infrastructure.
...
secure-terminal-ert-medical-desc =
    Deploys an ERT Medical detail for mass casualty triage and emergency surgery.
...
secure-terminal-ert-janitorial-desc =
    Deploys an ERT Janitorial detail for hazardous cleanup and station restoration.
...
secure-terminal-ert-chaplain-desc =
    Deploys an ERT Chaplain for crew morale and last rites support.
...
secure-terminal-code-gamma-desc =
    Escalates the station to [color=palevioletred]GAMMA[/color] alert. Martial law — all civilians are to be escorted by security to safe areas.
...
secure-terminal-code-psi-desc =
    Escalates the station to [color=mediumpurple]PSI[/color] alert. Hostile synthetic units detected — avoid non-conforming cyborgs and seek command staff.
...
secure-terminal-armory-gamma-desc =
    Dispatches the [color=palevioletred]Gamma Armory[/color] — heavy weapons cache for GAMMA situations. One-time deployment.
...
secure-terminal-armory-psi-desc =
    Dispatches the [color=mediumpurple]Psi Armory[/color] — anti-cybernetic weaponry for PSI situations. One-time deployment.
...
secure-terminal-med-pod-desc =
    Dispatches the Emergency Medical Pod — rapid-deployment triage with surgical and revival equipment.
...
secure-terminal-nukerequest-desc =
    Request the nuclear self-destruct codes.
