...
book-text-clown-mime-war =
    В начале 2300-х годов Транс-Солнечная Федерация (ТСФ) продолжала разрастаться в ту обширную межзвездную структуру, о которой мечтали её основатели, но тревожные открытия о Клоунах и Мимах продолжали накапливаться.
...
book-text-mars-incident =
    К 2100 году, благодаря огромному практически безлимитному финансированию Транс-Солнечной Федерации и технологическим чудесам, предоставленным NanoTrasen и Cybersun, были основаны первые постоянные колонии на Марсе.
