...
job-name-centcomm = чиновник CentComm
job-name-centcommoperator = оператор CentComm
job-name-nanotrasen-special-forces = оперативник NTSF
job-name-decimus = оперативник Decimus
job-name-nct = тренер по карьере Nanotrasen
...
role-type-corporate-aligned-name = корпоративно выровненный
role-type-corporate-aligned-color = #00b600
role-type-corporate-aligned-alternate-color = #1b67a5
job-rules-corporate-aligned =
    You are { role-type-corporate-aligned-name }.
...
role-type-tsf-aligned-name = выровненный по Транс-Солнечной Федерации
role-type-tsf-aligned-color = #22a7ff
job-rules-tsf-aligned =
    You are { role-type-tsf-aligned-name }.
