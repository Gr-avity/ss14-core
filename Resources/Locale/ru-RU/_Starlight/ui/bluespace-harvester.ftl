bluespace-harvester-window-title = Сборщик блюспейса
...
bluespace-harvester-current-power-use = Текущее потребление:
bluespace-harvester-power-for-next-level = Энергия для следующего уровня:
bluespace-harvester-network-supply = Снабжение сети:
bluespace-harvester-danger-warning = ВНИМАНИЕ: Небезопасный режим работы! Риск появления портала!
bluespace-harvester-blocked-warning = КРИТИЧНО: Обнаружен разлом блюспейса! Системы отключены до закрытия разлома!
