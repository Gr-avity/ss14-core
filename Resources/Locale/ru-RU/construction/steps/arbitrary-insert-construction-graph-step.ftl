...
construction-insert-arbitrary-entity = Вставьте { $stepName }.
construction-insert-info-examine-name-instrument-brass = медный духовой инструмент
...
construction-insert-info-examine-name-utensil = кухонную утварь
