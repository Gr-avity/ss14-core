...
steal-target-groups-stamps = печати (любые)
steal-target-groups-door-remotes = пульты от дверей (любые)
steal-target-groups-encryption-keys = ключи шифрования (любые)
