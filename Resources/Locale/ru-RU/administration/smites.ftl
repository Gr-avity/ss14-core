...
admin-smite-nyanify2-description = Насильно добавляет белые кошачьи ушки, от которых никуда не деться.
...
admin-smite-pacify-description = Делает цель пацифистом.
...
admin-trick-unbolt-description = Разболтирует шлюз.
admin-trick-bolt-description = Болтирует шлюз.
admin-trick-electrify-description = Подключает электричество к выбранному шлюзу.
admin-trick-unelectrify-description = Отключает электричество от выбранного шлюза.
admin-trick-emergency-access-on-description = Включает аварийный доступ шлюза.
admin-trick-emergency-access-off-description = Выключает аварийный доступ шлюза.
admin-trick-make-indestructible-description = Делает объект неуязвимым, фактически godmode.
admin-trick-make-vulnerable-description = Делает объект уязвимым снова, отключая godmode.
admin-trick-block-unanchoring-description = Не даёт закрепить объект.
admin-trick-refill-battery-description = Перезаряжает батарею объекта.
admin-trick-drain-battery-description = Разряжает батарею объекта.
...
admin-trick-halt-movement-description = Прекращает движение объекта, по крайней мере, пока что-то не сдвинет его снова.
...
admin-trick-set-bullet-amount-description = Устанавливает значение количества незаспавненных патронов в оружии.

## 🌟Starlight🌟

admin-trick-toggle-overlays-description = Переключает все оверлеи на цели.
admin-smite-scramble-name = Перемешать ДНК
admin-smite-scramble-description = Перемешивает их ДНК, делая персонажа случайным.

## 🌟Starlight🌟

admin-smite-terminate-warning = Я ещё вернусь...
