...
admin-verb-make-initial-infected = Превратите цель в нулевого зараженного.
...
admin-verb-make-changeling-wip = Сделать цель генокрадом (Upstream, WIP).
...
admin-verb-text-make-initial-infected = Сделать начальным заражённым
