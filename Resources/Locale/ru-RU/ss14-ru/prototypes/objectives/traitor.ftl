...
ent-DieObjective = Принять славную смерть
    .desc = Умрите.
ent-KillRandomPersonObjective = Убить цель
    .desc = Сделайте это как угодно, просто убедитесь, что они не покинут станцию.
ent-KillRandomHeadObjective = Убить главу
...
ent-RandomTraitorAliveObjective = Оставить цель в живых
    .desc = Раскройте свою личность на свой страх и риск. Нам просто нужно, чтобы они были живы.
ent-RandomTraitorProgressObjective = Помочь цели преуспеть
