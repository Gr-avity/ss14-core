...
ent-Implanter = экстрактор имплантов
    .desc = Двухцелевой шприц, предназначенный для удаления специфических подкожных имплантов. Как только имплант извлечен, он хранится внутри и может быть введен снова.
