...
ent-ActionSpiderBuildingPole = Web pole
    .desc = Spawns a web pole that spawns webs around at free tiles.
ent-ActionSpiderBuildingCocoon = Web cocoon
    .desc = Spawns a web cocoon that heals spider which entered in it.
ent-ActionEntityWrap = Wrap
    .desc = Wrap a target in web, immobilizing them.
