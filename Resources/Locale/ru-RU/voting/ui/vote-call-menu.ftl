...
ui-vote-trusted-users-notice =
    Этот тип голосования доступен только игрокам с достаточным временем игры или находящимся в белом списке (вайтлисте).
    Кроме того, вы должны пробыть призраком не менее { $timeReq } сек.
# Warning to not abuse a specific vote option.
ui-vote-abuse-warning =
    Внимание!
    Злоупотребление системой голосования за кик может привести к бессрочной блокировке (пермабану)!
# Hue hue hue
