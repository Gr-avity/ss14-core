...
roles-antag-nuclear-operative-commander-objective = Ведите свой отряд и уничтожьте станцию.
...
roles-antag-dragon-objective = Создайте армию карпов, чтобы захватить этот сектор.

# Starlight start
roles-antag-changeling-description = Используйте свои способности к превращению, чтобы выполнить поставленные цели.
# Starlight end
