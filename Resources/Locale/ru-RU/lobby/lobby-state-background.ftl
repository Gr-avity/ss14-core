...
lobby-state-background-skellyvstherev-title = Скелет против реввоша
lobby-state-background-skellyvstherev-artist = Hannah 'FairlySadPanda' Dawson
lobby-state-background-doomed-title = Обречённые
lobby-state-background-doomed-artist = brainfood1183
lobby-state-background-blueprint-title = Чертеж
...
lobby-state-background-justaweekaway-title = Всего через неделю
lobby-state-background-justaweekaway-artist = plantyfern
lobby-state-background-janishootout-title = Разборка уборщиков
lobby-state-background-janishootout-artist = psychpsyo
lobby-state-background-reclaimernuke-title = Ядерка в утилизаторе
