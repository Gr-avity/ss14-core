...
pacified-cannot-harm-indirect = Я не могу повредить { $entity }, это может кому-то навредить!
pacified-cannot-fire-gun = Я не могу стрелять из { $entity }, это может кому-то навредить!
