...
reagent-name-left4-zed = коктейль left-4-zed
...
reagent-desc-sedin = Модифицированная версия диэтиламина, которая может восстанавливать семена на растениях ценой потенции.
