...
reagent-desc-rororium = Странное вещество, которое заполняет ядра владык улья, бродящих по добывающему астероиду. Считается источником их регенеративных способностей.
