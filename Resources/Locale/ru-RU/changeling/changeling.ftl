...
roles-antag-changeling-objective = Умный хищник, принимающий облик своих жертв.

changeling-devour-attempt-failed-rotting = У этого трупа осталась только гнилая биомасса.
...
changeling-devour-consume-failed-not-dead = Это тело ещё живо! Мы не можем поглотить его заживо!
changeling-devour-consume-complete-self = Наша жуткая пасть скрывается, биомасса поглощена.
changeling-devour-consume-complete-others = { CAPITALIZE(POSS-ADJ($user)) } жуткая пасть скрывается.
