...
holopad-window-relay-label = Отправлено с:
...
holopad-window-filter-line-placeholder = Найти контакт
# Flavor
...
holopad-engineering-storage = Инженерный — Склад
