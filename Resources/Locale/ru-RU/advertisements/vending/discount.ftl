...
advertisement-discount-6 = Дискаунтер Дэна: Мы полезны вам! Не-а, не могу произнести это без смеха.
advertisement-discount-7 = Дискаунтер Дэна: Только высококачественная проду-*БЗзз
advertisement-discount-8 = Дискаунтер Дэн(tm) не несет ответственности за любой ущерб, вызванный неправильным использованием его продукции.
